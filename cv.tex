...
\cvitem{May 2025 - (Present)}{\textbf{Senior Software Engineer}, \textit{FlexiTech}, Minsk}
\cvitem{November 2022 - November 2024}{\textbf{Senior Software Engineer}, \textit{ControlUp}, Minsk}
\cvitem{September 2017 - September 2022}{\textbf{Software Developer}, \textit{Itransition Group}, Minsk}

\section{Skills}
\subsection{Main:}
\cvitem{}{\textbf{Back-end}: .NET 9, EF Core, xUnit, Kafka, Wolverine; }
\cvitem{}{\textbf{Front-end}: Angular 19; }
\cvitem{}{\textbf{Databases}: PostgreSQL, MongoDB, Redis, MS SQL; }
\cvitem{}{\textbf{Clouds}: AWS, Azure, On-prem; }
\cvitem{}{\textbf{CI/CD}: GitLab CI, Azure DevOps, GitHub Actions, TeamCity; }
\cvitem{}{\textbf{Monitoring \& alerting}: Grafana, Prometheus, Splunk, GrayLog; }
\cvitem{}{\textbf{Containers}: Docker, docker-compose, Helm. }

\subsection{Experience with:}
\cvitem{}{React, Go, Python, \LaTeX. }

\clearpage
\section{Projects}

\cventry{2025--Present}{FlexiTech}{}{}{}{
\begin{itemize}%
\item \textbf{Tools}: .NET 9 (Microservices), Kafka, PostgreSQL, Mongo, Redis, EF Core, Serilog, GitLab CI, Grafana, Prometheus, ELK, Docker, Helm, Vault; .NET Libraries and Practices: Wolverine (Outbox/Inbox pattern), DDD, FastEndpoints, AutoMapper, MediatR, xUnit.
\end{itemize}}
