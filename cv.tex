...
\cventry{November 2022 -- November 2024\hfill}{Senior Software Engineer}{ControlUp}{Minsk}{}{}
...
\section{Skills}
\subsection{Main:}
\cvitem{}{\textbf{Back-end}: .NET 8, .NET Standard, EF Core, Dapper, NUnit/xUnit; }
\cvitem{}{\textbf{Front-end}: Angular 17; }
\cvitem{}{\textbf{Databases}: MS SQL, MongoDB, PostgreSQL, Redis; }
\cvitem{}{\textbf{Clouds}: AWS, Azure, On-prem; }
\cvitem{}{\textbf{CI/CD}: Azure DevOps, GitHub Actions, TeamCity; }
\cvitem{}{\textbf{Monitoring \& alerting}: Splunk, GrayLog; }
\cvitem{}{\textbf{Containers}: Docker, docker-compose. }
